...
Data Engineering
I created a table schema for each of the six CSV files, specifying data types, primary keys, foreign keys, and other constraints. Then I imported each CSV file into the corresponding SQL table.
